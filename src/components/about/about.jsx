        ...
        <div className="row">
          ...
          <div className="aboutColumn">
            <p className="bodyCopy col2 par3">
              Founded by its 9-person Co-Creator-Team, Highlands is a two- night
              Folk Music getaway celebrating the musical talent of many youthful
              Folk (and Folk’ish!) performances on its 3 stage setup at Camp
              Walden this September 30 - October 2. Camp-style meals and basic
